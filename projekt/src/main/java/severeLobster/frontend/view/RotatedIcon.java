...
/**
 * 
 *Source: http://tips4java.wordpress.com/2009/04/06/rotated-icon/

 */

/**
 * Klasse ist nicht von mir, aber funktioniert vorerst. Source:
 * http://tips4java.wordpress.com/2009/04/06/rotated-icon/. The RotatedIcon
 * allows you to change the orientation of an Icon by rotating the Icon before
...
public class RotatedIcon implements Icon {
    ...
    public void paintIcon(Component c, Graphics g, int x, int y) {
        ...
        if (rotate == Rotate.DOWN) {
            ...
            Rectangle r = new Rectangle(x, y, icon.getIconWidth(),
                    icon.getIconHeight());
            g2.setClip(r);

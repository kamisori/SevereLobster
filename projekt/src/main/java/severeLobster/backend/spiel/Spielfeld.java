...
public class Spielfeld implements Serializable {
    ...
    /** Größe ist Konstant, aber Steine können über setter gesetzt werden */
     ...
     * müssen) - ansonsten wird der sichtbare Stein im Editiermodus nicht
    ...
    public void setSpielstein(final int x, final int y, Spielstein newStein)
        ...
        /** Spielmodus: */
        if (!isEditierModus()) {
            /** Außer Pfeilen darf im Spielmodus alles gesetzt werden */
            if (!(newStein instanceof Pfeil)) {
                visibleSteine[x][y] = newStein;
                /** Listener benachrichtigen */
     ...
     * Koordinaten außerhalb des Spielfeldes liegen
     */
     ...
     * Spielsteinen zurück. Die möglichen Spielsteine hängen vom SpielModus ab.
     * 
     * @return Eine Liste mit den fuer diese Koordinate aktuell auswählbaren
     *         Spielsteinen.
     */

 ...
 * Informationen, die von der GUI aufgerufen bzw angezeigt werden, sind über
 * diese Klasse zugängich sein - Direkt oder gekapselt. Instanz benachrichtigt
 * angemeldete ISternenSpielApplicationBackendListener, wenn sich irgendetwas am
 * Zustand der Anwendung ändert.
 * 
 * @author Lutz Kleiber
 * 
 */

...
public class ExitDialog extends JOptionPane {
    ...
    public static final String abbrechen_option = resourceManager.getText("exit.application.abbrechen.option");
    public static final String beenden_option = resourceManager.getText("exit.application.beenden.option");

    public static final String[] options = {beenden_option, abbrechen_option};

    public static int show(Component parentComponent) {
        return showOptionDialog(parentComponent, resourceManager.getText("exit.application.question"),
